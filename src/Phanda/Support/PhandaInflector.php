 ...
 *
 * PhandaInflector pluralizes and singularizes English nouns.
 */
class PhandaInflector
{
    /**
    ...
    public static function reset()
    {
        if (empty(static::$initialState)) {
            static::$initialState = get_class_vars(__CLASS__);
    ...
    public static function pluralize($word)
    {
        ...
        if (!isset(static::$cache['irregular']['pluralize'])) {
            static::$cache['irregular']['pluralize'] = '(?:' . implode('|', array_keys(static::$irregular)) . ')';
        }
        ...
        if (!isset(static::$cache['uninflected'])) {
            static::$cache['uninflected'] = '(?:' . implode('|', static::$uninflected) . ')';
        }
    ...
    public static function singularize($word)
    {
        ...
        if (!isset(static::$cache['irregular']['singular'])) {
            static::$cache['irregular']['singular'] = '(?:' . implode('|', static::$irregular) . ')';
        }
    ...
    /**
     * Returns Phanda model class name ("Person" for the database table "people".) for given database table.
     *
